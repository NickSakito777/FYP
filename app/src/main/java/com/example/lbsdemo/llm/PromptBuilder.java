...
public class PromptBuilder {
    ...
    public String buildAgentTaskPrompt(String userId, String characterId, int stage) {
        ...
        prompt.append("  \"agent_task_type\": \"任务类型(crucial_action或support)\",\n");
        prompt.append("  \"verification_method\": \"验证方法(对关键行动任务填写time+geofence，对支援任务填写photo)\",\n");
        prompt.append("  \"photo_verification_prompt\": \"照片验证的提示词\",\n");
        prompt.append("  \"duration_minutes\": 任务预计完成时间(分钟),\n");
